...
Overview
While my primary focus in recent years has been on Engineering Leadership and architecting large-scale enterprise systems, I remain deeply technical and hands-on. This project is a practical demonstration of my full-stack development capabilities, specifically using Python to build a scalable and containerized web application.
...
ORM & Database Integration: Utilizes SQLAlchemy to effectively model data relationships and interact with a PostgreSQL database, a skill I've applied with both SQL and NoSQL systems.
...
git clone https://github.com/amiralig/split-repo-pub.git
cd split-repo-pub
